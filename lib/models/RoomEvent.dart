...
class RoomEvent extends amplify_core.Model {
  ...
  const RoomEvent._internal({required roomId, required payload, createdAt, updatedAt}): _roomId = roomId, _payload = payload, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory RoomEvent({required String roomId, required List<EventItem> payload}) {
    return RoomEvent._internal(
      roomId: roomId,
      payload: payload != null ? List<EventItem>.unmodifiable(payload) : payload);
  }
  ...
  RoomEvent copyWith({List<EventItem>? payload}) {
    return RoomEvent._internal(
      roomId: roomId,
  ...
  RoomEvent copyWithModelFieldValues({
    ModelFieldValue<List<EventItem>?>? payload
  }) {
    return RoomEvent._internal(
      roomId: roomId,
    ...
    : _roomId = json['roomId'],
      _payload = json['payload'] is List
        ? (json['payload'] as List)
          .where((e) => e != null)
          .map((e) => EventItem.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'roomId': _roomId, 'payload': _payload?.map((EventItem? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: true,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'EventItem')
    ));
...
class RoomEventModelIdentifier implements amplify_core.ModelIdentifier<RoomEvent> {
  ...
  /** Create an instance of RoomEventModelIdentifier using [roomId] the primary key. */
  ...
  @override
  String toString() => 'RoomEventModelIdentifier(roomId: $roomId)';
