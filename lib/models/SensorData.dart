...
class SensorData extends amplify_core.Model {
  ...
  final List<SensorDataItem>? _payload;
  ...
  List<SensorDataItem>? get payload {
    return _payload;
  }
  ...
  const SensorData._internal({required roomId, payload, createdAt, updatedAt}): _roomId = roomId, _payload = payload, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory SensorData({required String roomId, List<SensorDataItem>? payload}) {
    return SensorData._internal(
      roomId: roomId,
      payload: payload != null ? List<SensorDataItem>.unmodifiable(payload) : payload);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is SensorData &&
      ...
      DeepCollectionEquality().equals(_payload, other._payload);
  }
  ...
  String toString() {
    ...
    buffer.write("payload=" + (_payload != null ? _payload!.toString() : "null") + ", ");
  ...
  SensorData copyWith({List<SensorDataItem>? payload}) {
    return SensorData._internal(
      roomId: roomId,
  ...
  SensorData copyWithModelFieldValues({
    ModelFieldValue<List<SensorDataItem>?>? payload
  }) {
    return SensorData._internal(
      roomId: roomId,
  ...
  SensorData.fromJson(Map<String, dynamic> json)  
    : _roomId = json['roomId'],
      _payload = json['payload'] is List
        ? (json['payload'] as List)
          .where((e) => e != null)
          .map((e) => SensorDataItem.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'roomId': _roomId, 'payload': _payload?.map((SensorDataItem? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: false,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'SensorDataItem')
    ));
...
class SensorDataModelIdentifier implements amplify_core.ModelIdentifier<SensorData> {
  ...
  /** Create an instance of SensorDataModelIdentifier using [roomId] the primary key. */
  ...
  @override
  String toString() => 'SensorDataModelIdentifier(roomId: $roomId)';
