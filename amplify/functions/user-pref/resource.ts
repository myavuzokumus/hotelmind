...
export const userPreferencesFunctionHandler = defineFunction(
  (scope) => {
    const lambdaFunction = new Function(scope, "user-preferences", {
      handler: "index.handler",
      runtime: Runtime.PYTHON_3_12,
      timeout: Duration.seconds(20),
      environment: {
        PREFERENCE_TABLE: "UserPreference-23zg6kw7jvc7vd6hacyznny2w4-NONE"
      },
    ...
    lambdaFunction.addToRolePolicy(new PolicyStatement({
      ...
      resources: [
        "arn:aws:dynamodb:eu-central-1:471112835770:table/UserPreference*"
      ]
    }));
