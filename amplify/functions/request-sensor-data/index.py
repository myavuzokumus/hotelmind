...
# DynamoDB table name
table_name = os.environ.get('DATA_TABLE', 'SensorData-23zg6kw7jvc7vd6hacyznny2w4-NONE')
...
def handler(event, context):
    try:
        print(f"Sensor history request: {json.dumps(event)}")
        ...
        response_topic = f"room/{room_id}/sensors/history/response"
        message = {
